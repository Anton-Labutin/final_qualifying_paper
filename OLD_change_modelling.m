...
car_2_rot_angle = pi / 6; % угол, на который натянута первая дуга окружности при перестроении 2-го автомобиля
car_1_mov_x = 0.5 * lane_width; % модуль перемещения по оси х 1-го автомобиля при каждом повороте при перестроении   
...
% Моделирование
        ...
        [car_2_total_motion_time_grid, car_2_total_motion_x_y_vx_vy_phi] = ...
            simulate_car_2_motion(motion_time, );
...
% автомобиля
            ...
            car_2_turn_1_R = lane_width / (2 * (1 + cos(pi - car_2_rot_angle)));
                
            if abs(car_2_turn_1_R - 1 / car_2_max_curvature) < 1e-1
                car_2_turn_1_R = 1 / car_2_max_curvature;
            end
            
            car_2_turn_1_time = car_2_rot_angle * car_2_turn_1_R / car_2_v;
...
% автомобиля
            ...
            car_2_turn_2_R = lane_width / (2 * (1 - cos(car_2_rot_angle)));
            
            if abs(car_2_turn_2_R - 1 / car_2_max_curvature) < 1e-1
                car_2_turn_2_R = 1 / car_2_max_curvature;
            end
            
            car_2_turn_2_time =  car_2_turn_2_R * car_2_rot_angle / car_2_v_start;
...
% ---------------- начальные параметры движения
                ...
                car_1_reaction_motion_time_grid_len = numel(car_1_reaction_motion_time_grid);
...
% ---------------- моделирование движения за время реакции (либо меньше, если время моделирования истекло или произошло столкновение)
                ...
                if ((~isfield(car_1_reaction_motion_sol, 'xe')) || ...
                   (numel(car_1_reaction_motion_sol.xe) == 0)) && ...
                   numel(car_1_change_and_left_time_grid) > 1
                   
                   % время моделирования не истеклоб, не произошло
                   % столкновение за время движения 1-го автомобиля по
                   % реакции
...
% ------------ перестроение 1-го автомобиля после движения по реакции
                    ...
                    for i = 2 : car_1_curvature_grid_len
...
% автомобиля
                        ...
                        car_1_rot_angle = acos(1 - car_1_mov_x / car_1_turn_1_R)
                        car_1_turn_1_time = car_1_rot_angle * car_1_turn_1_R / car_1_v;
    
                        car_1_turn_1_time_start =  car_1_change_and_left_time_grid(1);
                        car_1_turn_1_time_grid = car_1_change_and_left_time_grid(...
                            car_1_change_and_left_time_grid <= ...
                            (car_1_turn_1_time_start + car_1_turn_1_time) ...
                        );
...
%                         if numel(car_1_turn_2_time_grid) == 1
%                             tmp =  car_1_change_and_left_time_grid(...
%                                     car_1_change_and_left_time_grid > ...
%                                         car_1_turn_2_time_start + car_1_turn_2_time);
%                             car_1_turn_2_time_grid = [car_1_turn_2_time_grid, tmp(1)];
%                         end
...
% ------------ моделирование перестроения 1-го автомобиля (частичное, если произойдёт столкновение)
                        ...
                        if ((~isfield(car_1_change_sol, 'xe')) || ...
                           (numel(car_1_change_sol.xe) == 0)) && ...
                           numel(car_1_left_motion_time_grid) > 1
                   
                            % 1-й автомобиль перестроился, не врезался и
                            % время моделирования не закончилось
...
% моделирования
                            ...
                            total_motion_time_grid_prev = total_motion_time_grid;
...
%                             disp('START drawing');
% 
%                             ax.Title.String = ['Modelling: car\_1\_v = ', ...
%                                 num2str(car_1_v_start), ...
%                                 ' м/с, cars\_distance = ', ...
%                                 num2str(car_2_y_start - car_1_start_motion_param.y) ...
%                             ];
%         
...
%                                 num2str(happened_road_accident)] ...
%                             );
                            ...
                            car_2_total_motion_x_y_vx_vy_phi_omega_grid = [ ...
                                ...
                                car_2_x_y_vx_vy_phi_omega_grid(2 : ...
                                                    (car_1_reaction_motion_time_grid_len + ...
                                                    numel(car_1_change_time_grid) - 1), :) ...
                            ];
...
% -------- отрисовка
                        ...
                        numel(car_2_total_motion_x_y_vx_vy_phi_omega_grid(:, 1))
                        ...
                        total_motion_time_grid = total_motion_time_grid_prev;
                        car_1_total_motion_x_y_vx_vy_phi_omega_grid = car_1_total_motion_x_y_vx_vy_phi_omega_grid_prev;
                        car_2_total_motion_x_y_vx_vy_phi_omega_grid = car_2_total_motion_x_y_vx_vy_phi_omega_grid_prev;
...
disp(['Acceptable parameters: ', car_1_change_acceptable_v_dist_curv]);
