% Моделирование разгона управляемого автомобиля при перестроении 2го
% автомобиля
...
draw_motion_needed = true;
draw_motion_accident_needed = true;
draw_motion_ok_needed = true;
motion_video_needed = true;
...
% ---- либо до столкновения
        ...
        [car_1_time_grid, car_1_x_y_vx_vy_phi_grid, ...
            speedup_needed, road_accident_happened] = ...
